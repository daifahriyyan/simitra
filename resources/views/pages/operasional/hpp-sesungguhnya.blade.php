...
<head>
  ...
  <title>SIMITRA - HPP Sesungguhnya</title>
        ...
        <div class="container-fluid" id="container-wrapper">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="POST" action="{{ route('Tambah HPP Sesungguhnya') }}">
                    @csrf
                    <div class="mb-3">
          ...
          <div class="modal fade" id="editModal{{ $record->id }}" tabindex="-1" aria-labelledby="editModalLabel"
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="POST" action="{{ route('Ubah HPP Sesungguhnya', $record->id) }}">
                    @method('put')@csrf
                    <div class="mb-3">
                      <label for="id_beban_hpp" class="form-label">ID Beban HPP:</label>
                      <input type="text" class="form-control" id="id_beban_hpp" name="id_beban_hpp"
                        value="{{ $record->id_beban_hpp }}" readonly required>
                    </div>
                    <div class="mb-3">
                      <label for="tanggal_input" class="form-label">Tanggal Input:</label>
                    ...
                    <div class="mb-3">
                      <label for="bbb_sesungguhnya" class="form-label">BBB Sesungguhnya:</label>
                      <input type="number" class="form-control" id="bbb_sesungguhnya" name="bbb_sesungguhnya"
                        value="{{ $record->bbb_sesungguhnya }}" required>
                    </div>
                    <div class="mb-3">
                      <label for="btk_sesungguhnya" class="form-label">BTK Sesungguhnya:</label>
                      <input type="number" class="form-control" id="btk_sesungguhnya" name="btk_sesungguhnya"
                        value="{{ $record->btk_sesungguhnya }}" required>
                    </div>
                    <div class="mb-3">
                      <label for="bop_sesungguhnya" class="form-label">BOP Sesungguhnya:</label>
                      <input type="number" class="form-control" id="bop_sesungguhnya" name="bop_sesungguhnya"
                        value="{{ $record->bop_sesungguhnya }}" required>
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
          ...
          <div class="modal fade" id="deleteRecord{{ $record->id }}" tabindex="-1" aria-labelledby="deleteRecordLabel"
            ...
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                <form method="POST" action="{{ route('Hapus HPP Sesungguhnya', $record->id) }}">
                  @method('delete')@csrf
                  <div class="modal-body">
