...
<head>
  ...
  <title>SIMITRA - Persediaan</title>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="POST" action="{{ route('Ubah Persediaan', $record->id) }}">
                    ...
                    <div class="mb-3">
                      <label for="nama_persediaan" class="form-label">Nama Persediaan:</label>
                      <input type="text" class="form-control" id="nama_persediaan"
                        value="{{ $record->nama_persediaan }}" name="nama_persediaan" required>
                    </div>
                    <div class="mb-3">
                      <label for="quantity" class="form-label">Quantity:</label>
                    ...
                    <div class="mb-3">
                      <label for="saldo" class="form-label">Saldo:</label>
                      <input type="number" class="form-control" id="saldo" value="{{ $record->saldo }}" name="saldo"
                        required>
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
