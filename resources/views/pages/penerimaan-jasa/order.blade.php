                ...
                <div class="modal-body">
                  <form method="POST">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="vnama_customer" name="nama_customer" required
                        readonly>
                    </div>
                    <div class="mb-3">
                      <label for="telp_customer" class="form-label">Telepon Customer:</label>
                      <!-- Input ini akan diisi otomatis berdasarkan pilihan ID Customer -->
                      <input type="text" class="form-control" id="vtelp_customer" name="telp_customer" required
                        readonly>
                    </div>
                    <div class="mb-3">
                  ...
                  <form method="POST">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="container" name="container"
                        value="{{ $record->container }}" required>
                    </div>
                    <div class="mb-3">
                      <label for="container_volume" class="form-label"> Container Volume:</label>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="commodity" name="commodity"
                        value="{{ $record->commodity }}" required>
                    </div>
                    <div class="mb-3">
                      <label for="vessel" class="form-label">Vessel:</label>
                      <input type="text" class="form-control" id="vessel" name="vessel" value="{{ $record->vessel }}"
                        required>
                    </div>
                    <div class="mb-3">
                  ...
                  <table class="table align-items-center table-flush table-hover text-nowrap" id="dataTableHover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href='{{ asset("storage/packing_list/$item->packing_list") }}'>{{ $item->packing_list
                            }}</a></td>
                        <td>
                          <?php
