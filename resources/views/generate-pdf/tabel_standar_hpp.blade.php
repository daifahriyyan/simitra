...
<body>
  <div class="container">
    ...
    <div class="request-info">
      <h3 style="text-align: center; font-weight: bold; text-decoration: underline;">DATA HPP STANDAR</h3>
      <br>
      <table class="custom-table">
        <tr>
          <th style="width: 5%;">No</th>
          <th>Id Standar</th>
          <th style="width: 20%;">BBB/feet</th>
          <th style="width: 20%;">BTK/feet</th>
          <th style="width: 20%;">BOP/feet</th>
          <th style="width: 20%;">Jumlah HPP/feet</th>
        </tr>
        ...
        <tr>
          ...
          <td style="text-align: right;">2000.000</td>
          <td style="text-align: right;">3000.000</td>
          <td style="text-align: right;">7000.000</td>
        </tr>
        <tr>
          <td>no urut</td>
          <td>get id hpp standar</td>
          <td style="text-align: right;">get data BBB</td>
          <td style="text-align: right;">get data BTK</td>
          <td style="text-align: right;">get data BOP</td>
          <td style="text-align: right;">get data Jumlah</td>
        </tr>
      </table>
      <br>
      <br>
