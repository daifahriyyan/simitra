...
<head>
  ...
  <title>Rekap HPP Sesungguhnya</title>
...
<body>
  <div class="container">
    ...
    <div class="request-info" style="font-size: 12px">
      <h3 style="text-align: center; font-weight: bold; text-decoration: underline;">REKAP HPP SESUNGGUHNYA</h3>
      <br>
      <table class="custom-table">
        <tr>
          ...
          <th>Id HPP</th>
          <th>Tanggal Input</th>
          <th style="width: 15%;">BBB Sesungguhnya</th>
          <th style="width: 15%;">BOP Sesungguhnya</th>
