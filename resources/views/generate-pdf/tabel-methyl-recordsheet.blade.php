...
<head>
  ...
  <title>Daftar Methyl Recordsheet</title>
  <style>
    body {
...
<body>
  <div class="container">
    ...
    <div class="request-details">
      <h3 style="text-align: center; font-weight: bold; text-decoration: underline;">DAFTAR METHYL RECORDSHEET</h3>
      <table>
        <tr>
        ...
        <tbody>
          @foreach ($metilRecordsheet as $record)
          <tr>
            ...
            <td>{{ $record->dokumen_metil_recordsheet }}</td>
          </tr>
          @endforeach
      </table>
    </div>
